export function WhatsAppIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.555 4.112 1.525 5.84L.057 23.5l5.803-1.525A11.928 11.928 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.877 0-3.63-.498-5.145-1.369l-.367-.217-3.44.903.917-3.356-.235-.383A9.941 9.941 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
    </svg>
  )
}
...
export function DragHandleIcon({ size = 18 }: { size?: number }) {
  return (
